...
import { ComboChip, type ComboOption, ToolDot } from "./primitives";
...
function SearchTrigger({
  ...
  return (
    <button
      type="button"
      onClick={onOpen}
      title="Open command palette (⌘K) — search pages, sessions, actions"
      className={clsx(
  ...
  return (
    <ComboChip
      ...
      buttonValueRender={(sel) => {
        ...
        return (
          <b
            className="max-w-[200px] truncate font-mono text-[11px] font-semibold text-fg-0"
            title={value}
          >
            {shortenPath(value)}
          </b>

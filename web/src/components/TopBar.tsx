...
import type { SetupClaude, StatusSnapshot } from "@/lib/types";
    ...
    <header className="flex h-[var(--header-h)] items-center justify-between gap-3 border-b border-line-1 bg-bg-1 px-5">
      ...
      <div className="flex items-center gap-2 text-[11px] text-fg-3">
        ...
        <button
          ...
          title="Export the current page's data as JSON"
        ...
        <button
          type="button"
          onClick={refresh}
          title="Reload data on every visible card"
        ...
        <ThemeToggle />
        {onHelp && (
          <IconButton title="Help · press ?" onClick={onHelp}>

...
import { ChartShell, PageHeader, Pill, SlideOver, StatCard } from "@/components/primitives";
        ...
        <aside className="border-r border-line-1 bg-bg-1 p-4">
          ...
          {config.data && (
            <div className="mt-6 rounded-2 border border-line-1 bg-bg-2 px-3 py-2 text-[10.5px] text-fg-3">
              ...
              <div
                className="break-all font-mono text-fg-2"
                title={config.data.config_path}
              >
        ...
        sub={
          <>
            ...
            {configPath && (
              <>
                {" · "}
                <span className="font-mono text-fg-2" title={configPath}>
                  {configPath}
                </span>
              </>
            )}
      ...
      right={
        <div className="flex items-center gap-2 text-[11px]">
          ...
          <button
            ...
            title="Jump to baked-in defaults"
          >
          ...
          <button
            ...
            title="Pick a default model and add a pricing override"
          >
            + Add override
          </button>
          <button
      ...
      right={
        status.data && status.data.modes.length > 0 ? (
          <button
            ...
            disabled={anyRunning}
            className="rounded-2 border border-accent/40 bg-accent-soft px-3 py-1 text-[11px] font-medium text-accent disabled:opacity-40"
            title="Fire every mode in sequence"
          >

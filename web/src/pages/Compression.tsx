...
export function CompressionPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      />
      <SetupBanner claude={setupClaude.data} codex={setupCodex.data} />
        ...
        <tbody>
          {rows.map((r) => {
            ...
            return (
              ...
              >
                <td
                  className="py-1.5 pl-2 text-fg-2"
                  title={r.timestamp}
                >
                ...
                <td className="py-1.5 text-right tabular-nums">
                  {r.importance_score > 0 ? (
                    <span
                      ...
                      title={`importance_score = ${r.importance_score.toFixed(3)}`}
                    >
            ...
            <div className="rounded-2 border border-line-1 bg-bg-3/40 p-3">
              ...
              <ul className="space-y-1 text-[11px]">
                {data.top_retrieved_shas.slice(0, 8).map((s) => (
                  ...
                  >
                    <span className="truncate font-mono text-fg-1" title={s.sha}>
                      {s.sha.slice(0, 12)}…
                    </span>

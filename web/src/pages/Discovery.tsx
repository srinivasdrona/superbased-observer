            ...
            return (
              ...
              >
                <td className="py-1.5 pl-2">
                  ...
                  >
                    <span className="block truncate" title={r.file_path}>
            ...
            return (
              ...
              >
                <td className="py-1.5 pl-2">
                  ...
                  >
                    <span className="block truncate" title={r.command}>
                      {r.command}
                    </span>
                  </CopyOnClick>
                </td>
      ...
      <div className="mx-auto max-w-[640px] text-center">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
          <a
            ...
            title="Open Settings → Hooks to configure Cursor"
          >
            Configure Cursor
          </a>
          <a
            href="/settings"
            className="flex h-7 items-center gap-1.5 rounded-2 border border-line-2 bg-bg-2 px-3 text-[11px] text-fg-2 hover:bg-bg-3 hover:text-fg-0"
            title="Open Settings → Hooks to configure Codex"
          >
            Configure Codex
          </a>
          <a

...
const (
	...
	// TTLGuard covers the §14.3 guard rollups (overview / rules / teams).
	// The audited per-agent chain report is deliberately uncached — every
	// disclosure must hit its audit write.
	TTLGuard = 30 * time.Second
)

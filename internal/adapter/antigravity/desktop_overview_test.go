...
func TestTranscriptPathFor(t *testing.T) {
	cases := []struct {
		...
		{
			name:        "desktop → overview.txt",
			sessionPath: "/home/u/.gemini/antigravity/conversations/xyz.pb",
			convID:      "xyz",
			want:        "/home/u/.gemini/antigravity/brain/xyz/.system_generated/logs/overview.txt",
		},
		{
			name:        "WSL desktop → overview.txt under /mnt/c",
			sessionPath: "/mnt/c/Users/auzy_/.gemini/antigravity/conversations/c15725c6.pb",
			convID:      "c15725c6",
			want:        "/mnt/c/Users/auzy_/.gemini/antigravity/brain/c15725c6/.system_generated/logs/overview.txt",
		},
		{

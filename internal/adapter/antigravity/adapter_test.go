...
func TestMatchesSessionShape(t *testing.T) {
	cases := []struct {
		...
		{"/home/u/.gemini/antigravity/conversations/abc.pb", true, "linux native"},
		{`C:\Users\u\.gemini\antigravity\conversations\abc.pb`, true, "windows path"},
		{"/mnt/c/Users/u/.gemini/antigravity/conversations/x.pb", true, "wsl cross-mount"},

...
// (see docs/antigravity-path-b-implementation-handoff-2026-05-04.md
// and docs/antigravity-tier-1-2-3-handoff-2026-05-04.md for the
// verification log):
//
...
// trajectory into a readable path. Uses decodeFileURIToRoot's URL
// decoding + crossmount translation but keeps the trailing filename
// (decodeFileURIToRoot strips it for project-root resolution).

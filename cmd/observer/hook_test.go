...
// TestInstallHookWatchdogFiresOnExceededRuntime pins the V3-1 fix: when
// a hook runs past its budget, the watchdog must call exitFn(2) so the
// host AI tool isn't pinned waiting on a stuck subprocess.

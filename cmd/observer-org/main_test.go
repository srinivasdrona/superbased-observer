...
func TestMigrateAndDumpConfig(t *testing.T) {
	...
	// Schema 6 = the guard arc's paired server migrations (004 policy
	// bundles at G13, 005 guard_events at G14) plus the model-routing
	// arc's 006_routing (renumbered from 004 at the 2026-06-11 merge).
	if !strings.Contains(out, "schema version = 6") {
